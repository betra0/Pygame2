...
class nave_enemy(pygame.sprite.Sprite):
        ...
        def update(self):
            if self.IA:
                self.contador += 1
                if len(cordenadasjugador) >= 9:

                    xf, yf = cordenadasjugador[-5]
...
class disparo_enemy(pygame.sprite.Sprite):
        ...
        def direcionbala(self, x, y):
            ...
            xf, yf = cordenadasjugador[1]

            distanciax = xf - x
            if distanciax <0:
                 distanciapositivax = distanciax*-1
            else:
                distanciapositivax = distanciax
            
            
            distanciay = yf - y
        
            if distanciay <0:
                distanciapositivay = distanciay*-1
            else:
                distanciapositivay = distanciay
            print("distancias:", distanciapositivax, distanciapositivay)
            if distanciapositivax ==0 or distanciapositivay == 0:
                if distanciapositivax ==0:
                    newx = 0
                    newy = self.speed
                else:
                    newy = 0
                ...
                newy = ((self.speed**2)/((distanciapositivax / distanciapositivay)+1))**0.5            
                newx = (self.speed**2 -(newy**2))**0.5
            ...
            self.speedx, self.speedy = newx, newy

        def activardisparo(self, x, y):
            if self.activate == False and len(cordenadasjugador) >= 5:
                self.activate = True
